\>\> [题目链接](https://leetcode.com/explore/featured/card/may-leetcoding-challenge-2021/600/week-3-may-15th-may-21st/3744/)

题意: 给定一个字符串 `s`, 判断其是否是一个合法数字

解答: 先找到字符串中是否存在科学记数法的 `e` 或者 `E`, 然后分别判断前后两个部分是否合法
