\>\> [题目链接](https://leetcode.com/explore/featured/card/may-leetcoding-challenge-2021/600/week-3-may-15th-may-21st/3747/)

题意: 给定一组字符串 `paths` 表示一组目录和文件以及文件内容, 找出所有内容重复的文件并且把重复文件位置分组返回
