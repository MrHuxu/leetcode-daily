\>\> [题目链接](https://leetcode.com/explore/featured/card/may-leetcoding-challenge-2021/602/week-5-may-29th-may-31st/3762/)

题意: 实现一个搜索建议系统, 给定备选组 `products`, 以及输入单词 `searchWord`, 返回一个二维数组, 即每输入一个字符应该建议的单词列表
